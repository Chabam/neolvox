...
class CTLIBLAZ_EXPORT CT_Exporter_LAZ : public CT_AbstractExporter
{
    Q_OBJECT
    using SuperClass = CT_AbstractExporter;

public:
    CT_Exporter_LAZ(int subMenuLevel = 0);
    CT_Exporter_LAZ(const CT_Exporter_LAZ& other);
    ...
    CT_EXPORTER_DECL_COPY(CT_Exporter_LAZ)
