#ifndef CT_LAZPOINTFORMAT2_H
#define CT_LAZPOINTFORMAT2_H
...
class CTLIBLAZ_EXPORT CT_LAZPointFormat2 : public CT_LAZPointFormat0, public CT_LAZColorPacket
{
public:
    CT_LAZPointFormat2();
...
protected:
     ...
     */
    void writeInfoFormat2(laszip_point* lzPoint, const size_t& globalIndex) const;
};

#endif // CT_LAZPOINTFORMAT2_H
