#ifndef LVOX3_STEPCONFIGURESCANNER_H
#define LVOX3_STEPAKESHOOTINGPATERNFORMLS_H
...
class LVOX3_StepConfigureScanner : public CT_AbstractStep
{
    Q_OBJECT
...
#endif // LVOX3_STEPCONFIGURESCANNER_H
