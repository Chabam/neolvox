...
static auto bm_point_cloud_size(benchmark::State& state, bool is_sparse) -> void
{
    for (auto _ : state)
    {
        ...
        const auto       view = generate_cubic_point_cloud_with_random_points(table, state.range(0), 30, 40, 20);
...
BENCHMARK_CAPTURE(bm_point_cloud_size, sparse, true)->Arg(10'000)->Arg(100'000)->Arg(1'000'000)->Arg(10'000'000);
BENCHMARK_CAPTURE(bm_point_cloud_size, dense, false)->Arg(10'000)->Arg(100'000)->Arg(1'000'000)->Arg(10'000'000);
