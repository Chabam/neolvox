#ifndef LVOX3_INTERPOLATEKRIGINGNORMAL_H
#define LVOX3_INTERPOLATEKRIGINGNORMAL_H

#include <QObject>
#include "lvox3_worker.h"
#include "tools/lvox3_gridtype.h"

class LVOX3_InterpolateKrigingNormal
        : public LVOX3_Worker
{
    Q_OBJECT
public:
...
LVOX3_InterpolateKrigingNormal(const lvox::Grid3Df *originalDensityGrid,
...
#endif // LVOX3_INTERPOLATEKRIGINGNORMAL_H
