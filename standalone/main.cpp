...
)
{
    ...
    // Min index
    {
        H5::Attribute min_index_attr = get_or_create_attribute(
            "Minimal index values", h5_bounds_index_t, singular_3d_coord_data_space
        );
        ...
        min_index_attr.write(h5_bounds_index_t, min_indices.data());
    }
    ...
    // Max index
    {
        ...
        max_index_attr.write(h5_bounds_index_t, max_indices.data());
    }
