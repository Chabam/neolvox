 ...
 * @date 13-03-2019
 * @version 1
 * @ Shooting pattern compatible with pbrt
 */
#ifndef LVOX3_THETAPHISHOOTINGPATTERN_H
#define LVOX3_THETAPHISHOOTINGPATTERN_H
 ...
 */
class LVOX3_ThetaPhiShootingPattern : public CT_ShootingPattern
{
public:
     ...
     */
    LVOX3_ThetaPhiShootingPattern(const Eigen::Vector3d& origin,
     ...
     */
    LVOX3_ThetaPhiShootingPattern(const LVOX3_ThetaPhiShootingPattern& other);
