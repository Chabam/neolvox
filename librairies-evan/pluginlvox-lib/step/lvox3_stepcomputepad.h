...
#include <QStack>
#include <liblvox/algorithms/computepad.h>
...
public:
    ...
    QString parametersDescription() final;
...
private :
    ...
    CT_HandleInSingularItem<pluginlvox::Grid3Di >     _inDeltaHits;
    CT_HandleInSingularItem<pluginlvox::Grid3Di >     _inDeltaTheo;
    CT_HandleInSingularItem<pluginlvox::Grid3Di >     _inDeltaBefore;
    CT_HandleInSingularItem<CT_Grid3D<int>>           _inHitRef;

    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_PADCF;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_PADMLE;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_PADBCMLE;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_PADBL;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_PADBCBL;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_PADBC2BL;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_FreeSum;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_FreeEffSum;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_DeltaSum;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_DeltaEffSum;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_DeltaEffSquareSum;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df> _out_1ZleDeltaEffSum;
