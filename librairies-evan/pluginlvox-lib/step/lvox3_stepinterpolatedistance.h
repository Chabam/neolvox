...
protected:
     ...
     */
    void ZAverageInterpolation(const pluginlvox::Grid3Df *INdensityGrid,pluginlvox::Grid3Df* const OUTdensityGrid,const pluginlvox::Grid3Di *hitGrid,const pluginlvox::Grid3Di *theoreticalGrid,const pluginlvox::Grid3Di *beforeGrid);
...
private:
    ...
    CT_HandleOutSingularItem<pluginlvox::Grid3Df>                         _outGrid_density;
