    ...
    for (CT_StandardItemGroup* group : _inGroup.iterateOutputs(_inResult))
    {
        ...
        if (inGrid != NULL)
        {
            ...
            if((inGrid->xdim() > 0)
                ...
                pluginlvox::Grid3Df *outGrid = new pluginlvox::Grid3Df(inGrid->minX(), inGrid->minY(), inGrid->minZ(), inGrid->xdim(), inGrid->ydim(), inGrid->zdim(), inGrid->xresolution(),inGrid->yresolution(),inGrid->zresolution(), lvox::Max_Error_Code, 0);
