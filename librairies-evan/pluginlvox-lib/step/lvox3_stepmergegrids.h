...
#include "liblvox/reducers/base.h"
...
private:
    ...
    CT_HandleInSingularItem<pluginlvox::Grid3Di >                         _inGrid_ni;
    CT_HandleInSingularItem<pluginlvox::Grid3Di >                         _inGrid_nt;
    CT_HandleInSingularItem<pluginlvox::Grid3Di >                         _inGrid_nb;
    CT_HandleInSingularItem<pluginlvox::Grid3Df >                         _inGrid_density;


    CT_HandleOutResultGroup                                         _outResult;
    CT_HandleOutStdGroup                                            _outRootGroup;
    CT_HandleOutSingularItem<pluginlvox::Grid3Di>                         _outGrid_ni;
    CT_HandleOutSingularItem<pluginlvox::Grid3Di>                         _outGrid_nt;
    CT_HandleOutSingularItem<pluginlvox::Grid3Di>                         _outGrid_nb;
    CT_HandleOutSingularItem<pluginlvox::Grid3Df>                         _out_Density;
