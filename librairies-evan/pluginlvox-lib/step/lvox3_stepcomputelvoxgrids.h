...
public:
    ...
    using GridMode = lvox::ComputeLvoxGrids::GridMode;
...
private:
    ...
    CT_HandleOutSingularItem<pluginlvox::Grid3Di>                                             _outHits;
    CT_HandleOutSingularItem<pluginlvox::Grid3Di>                                             _outTheo;
    CT_HandleOutSingularItem<pluginlvox::Grid3Di>                                             _outBef;
    CT_HandleOutSingularItem<CT_Grid3D<int>>                                                  _outRefHits;
    ...
    lvox::ComputeLvoxGrids::GridMode        m_gridMode;
