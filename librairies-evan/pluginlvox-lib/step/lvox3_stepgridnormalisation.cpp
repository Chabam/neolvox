...
void LVOX3_StepGridNormalisation::compute()
{
    ...
    for (CT_StandardItemGroup* group : _inGroup.iterateOutputs(_inResult))
    {
        ...
        pluginlvox::Grid3Df* itemoutiConteur = new pluginlvox::Grid3Df(inGrid->minX(), inGrid->minY(), inGrid->minZ(), xdim, ydim, zdim, xres, yres, zres, NAin, NAin);
        pluginlvox::Grid3Df* elevationGrid = new pluginlvox::Grid3Df(inGrid->minX(), inGrid->minY(), inGrid->minZ(), xdim, ydim, zdim, xres, yres, zres, NAd, NAd);
