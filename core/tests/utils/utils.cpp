...
pdal::PointViewPtr generate_cubic_point_cloud(
    pdal::PointTableRef table, double dim_x, double dim_y, double dim_z
)
{
...
pdal::PointViewPtr generate_cubic_point_cloud_with_random_points(
    pdal::PointTableRef table, size_t point_count, double dim_x, double dim_y, double dim_z
)
{
    table.layout()->registerDim(pdal::Dimension::Id::X);
    table.layout()->registerDim(pdal::Dimension::Id::Y);
